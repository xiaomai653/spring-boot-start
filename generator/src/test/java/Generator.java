...
public class Generator {
    ...
    public static void before() throws SQLException {
        ...
        InputStream inputStream = com.springboot.Generator.class.getResourceAsStream("/sql/sys_user.sql");
    ...
    private static final DataSourceConfig DATA_SOURCE_CONFIG = new DataSourceConfig
            .Builder("jdbc:mysql://localhost:3306/xiaomai?characterEncoding=UTF-8&useUnicode=true&useSSL=false&serverTimezone=Asia/Shanghai","root","123456").build();
    ...
    private StrategyConfig.Builder strategyConfig() {
        // 设置需要生成的表名
        return new StrategyConfig.Builder().addInclude("user");
    }
